...
import { Filters, TeamData, checkHomeAwayFilter, filterAbgesagt, filterPlaces, getFilterPlaces, setDefaultTeamsUiFilterState } from '@fcschwarzach/shared-generalplan-api';
